...
JNIEXPORT void JNICALL
Java_java_lang_System_hello(JNIEnv *env, jclass cls, jobject obj)
{
    printf("hello");
...
//    (*env)->Hello(env, cls);
    ...
    JVM_Hello(env, cls, obj);
}

JNIEXPORT jint JNICALL
Java_java_lang_System_getObjectFieldIntVal(JNIEnv *env, jclass cls, jobject obj, jint offset)
{
//    printf("hello");
...
//    JVM_Hello(env, cls, obj);
    ...
    return JVM_GetObjectFieldIntVal(env, cls, obj, offset);
}
