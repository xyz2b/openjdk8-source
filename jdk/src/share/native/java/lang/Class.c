...
static JNINativeMethod methods[] = {
    ...
    {"isArray2",         "()Z",             (void *)&JVM_IsArrayClass2},
//    {"isTest",           "()Z",             (void *)&JVM_IsTest},
...
Java_java_lang_Class_isTest(JNIEnv *env, jclass cls)
{
    return 1;
}
...
JNIEXPORT jboolean JNICALL
Java_java_lang_Class_test(JNIEnv *env, jobject cls, jobject obj)
{
    return 1;
}
...
JNIEXPORT jboolean JNICALL
Java_java_lang_Class_isInstance2(JNIEnv *env, jobject cls, jobject obj)
{
    if (obj == NULL) {
        return JNI_FALSE;
    }
