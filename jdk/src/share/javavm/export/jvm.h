...
JVM_Hello(JNIEnv *env, jclass cls, jobject obj);

JNIEXPORT jint JNICALL
JVM_GetObjectFieldIntVal(JNIEnv *env, jclass cls, jobject obj, jint offset);
...
JNIEXPORT jstring JNICALL JVM_GetClassName1(JNIEnv *env, jclass cls);
...
JNIEXPORT jboolean JNICALL
JVM_IsArrayClass2(JNIEnv *env, jclass cls);

JNIEXPORT void JNICALL
JVM_ShowInfos(JNIEnv *env, jobject obj);

JNIEXPORT jboolean JNICALL
JVM_IsTest(JNIEnv *env, jclass cls);
